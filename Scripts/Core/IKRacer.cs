    ...
    public class IKRacer : MonoBehaviour
    {
      ...
      //  [HideInInspector]
        ...
        void Awake()
        {
			...
			if (transform.root.GetComponent<ISpeed>())
            {
				car_controller = transform.root.GetComponent<ISpeed>();
            }
        ...
        void HeadLook()
        {
			...
			if(car_controller) steer = car_controller.info.steer;
